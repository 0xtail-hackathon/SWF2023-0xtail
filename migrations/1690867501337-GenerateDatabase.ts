...
export class GenerateDatabase1690867501337 implements MigrationInterface {
    name = 'GenerateDatabase1690867501337'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE \`artifact\` (\`id\` bigint UNSIGNED NOT NULL AUTO_INCREMENT, \`name\` varchar(255) NOT NULL, \`address\` varchar(255) NOT NULL, \`exc_loc\` varchar(255) NOT NULL, \`cur_loc\` varchar(255) NOT NULL, \`era\` varchar(255) NOT NULL, \`category\` varchar(255) NOT NULL, \`size\` varchar(255) NOT NULL, \`coll_num\` varchar(255) NOT NULL, \`img_url\` varchar(255) NOT NULL, \`value\` bigint NOT NULL, \`strt_date\` varchar(255) NOT NULL, \`exp_date\` varchar(255) NOT NULL, \`created_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updated_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), UNIQUE INDEX \`IDX_b5567c51d2b49291baba57cd97\` (\`name\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
